...
const DriversArray: any[] = [
	...
	},
	{
		...
		"rating": 4,
		"ratingText": "Que viagem incrível! O carro é um show à parte e o motorista, apesar de ter uma cara de poucos amigos, foi super gente boa. Recomendo!",
		"rate": 5,
		"minimumKm": 5
	},
	{
		...
		"rating": 5,
		"ratingText": "Serviço impecável! O motorista é a própria definição de classe e o carro é simplesmente magnífico. Uma experiência digna de um agente secreto.",
		"rate": 10,
		"minimumKm": 10
	}
]
